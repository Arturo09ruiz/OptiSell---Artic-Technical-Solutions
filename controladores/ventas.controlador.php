...
//				$printer -> pulse(); //Por medio de la impresora mandamos un pulso, es útil cuando hay cajón moneder
	...
	static public function ctrEditarVenta(){
		...
		if(isset($_POST["editarVenta"])){
			...
			$datos = array("id_vendedor"=>$_POST["idVendedor"],
						   ...
						   "falta"=>$_POST["falta_por_dolares_2"],
						   "metodo_pago_2"=>$_POST["listaMetodoPago2"],
						   "tasadeldia"=>$_POST["tasadiae"],
						   );
	...
	static public function ctrEditarVentaTercer(){
		...
		if(isset($_POST["editarVenta"])){
			...
			$datos = array(
							"codigo"=>$_POST["editarVenta"],
						   "falta"=>$_POST["falta_por_dolares_2"],
						   "metodo_pago_3"=>$_POST["listaMetodoPago3"],
						   "tasadeldia"=>$_POST["tasadiae"],
						   );


			$respuesta = ModeloVentas::mdlEditarVentaTercer($tabla, $datos);
	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			echo utf8_decode("<table border='0'> 
					...
					<td style='font-weight:bold; border:1px solid #eee;'>METODO DE 1 PAGO</td>
					<td style='font-weight:bold; border:1px solid #eee;'>METODO DE 2 PAGO</td>
					<td style='font-weight:bold; border:1px solid #eee;'>METODO DE 3 PAGO</td>
			 ...
			 echo utf8_decode("<tr>
				...
				// }
		 		...
		 		echo utf8_decode("</td>
					...
					<td style='border:1px solid #eee;'>".$item["metodo_pago_2"]."</td>
					<td style='border:1px solid #eee;'>".$item["metodo_pago_3"]."</td>
