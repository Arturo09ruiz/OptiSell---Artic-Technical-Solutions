...
$(".tablaterminados tbody").on("click", "button.btn_entregado", function () {
	var datos = new FormData();
	datos.append("idterminado", idterminado);
	
	var idterminado = $(this).attr("idterminado");
	var codigo = $(this).attr("codigo");
				...
				$.ajax({
					...
					// processData: false,
					 // dataType: "json",
						...
						type: "POST",
								url: "ajax/prueba-terminados.ajax.php",
								data:'idterminado=' + idterminado ,
								dataType:"html",
								asycn:false, //el error que cometí de sintaxis, es async
									success: function (respuesta) {
									 document.forms["prueba-entregados"].submit();
