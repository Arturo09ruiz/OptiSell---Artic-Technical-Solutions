...
$(".tablapedidos tbody").on("click", "button.btn_terminadopedidos", function () {
	var datos = new FormData();
	datos.append("idpedidos", idpedidos);
	...
	document.getElementById("lugar_terminado").value = lugar;
	...
	document.getElementById("fecha_de_terminado").value = hoy;
		...
		swal({
			...
			confirmButtonText: 'Si, El Pedido Ha Llegado!'
				...
				$.ajax({
					...
					// processData: false,
					 // dataType: "json",
						...
						type: "POST",
								url: "ajax/pruebapedidos.ajax.php",
								data:'idpedidos=' + idpedidos ,
								dataType:"html",
								asycn:false, //el error que cometí de sintaxis, es async
									success: function (respuesta) {
									 document.forms["pruebapedidos"].submit();
