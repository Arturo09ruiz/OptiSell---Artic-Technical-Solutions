...
<br>
      ...
      <div id="mostrarOcultar3">
              <h3 class="cout">Agregar 3 Pago </h3>
...
<select class="form-control" id="nuevoMetodoPago3" name="nuevoMetodoPago3">
...
<div class="cajasMetodoPago3"></div>
<input type="hidden" id="listaMetodoPago3" name="listaMetodoPago3">
...
<?php
          ...
          $editarVentaTercer = new ControladorVentas();
          $editarVentaTercer -> ctrEditarVentaTercer();
