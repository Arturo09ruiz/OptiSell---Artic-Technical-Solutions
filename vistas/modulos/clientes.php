          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" id="nuevoCliente" class="form-control nuevoCliente input-lg" name="nuevoCliente" placeholder="Ingresar nombre" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" id="nuevoHistoria" class="form-control nuevoHistoria input-lg" name="nuevoHistoria" placeholder="Ingresar Número de Historia">
