...
class Modeloterminados{
	...
	static public function mdlIngresarterminados($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(tipo_cristal, aumento_cristal, codigo, descripcion, stock,precio_compra,precio_venta,fecha_terminado) VALUES (:tipo_cristal, :aumento_cristal, :codigo, :descripcion,  :stock,:precio_compra, :precio_venta, :fecha_terminado)");
